...
public class Md5 {
	 ...
	 * @return
	 */
	public static String getMD516Upper(String input) {
		return getMD516(input).toUpperCase();
	}
	/**
	 * 32位 小写
	 * @param input
	 ...
	 * @return
     */
	public static String getMD532Upper(String input){
		return getMD532(input).toUpperCase();
	}

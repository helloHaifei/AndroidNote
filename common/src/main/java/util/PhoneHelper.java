...
public class PhoneHelper {
    ...
    public static TelephonyManager getTelephonyManager() {
        TelephonyManager tm = (TelephonyManager) ContextUtil.getApplicationContext()
    ...
    public static boolean isNetWorkType4G() {
        boolean is4G = false;
        NetworkInfo info = NetUtil.getNetworkInfo();
        if (info != null && info.isAvailable()) {
    ...
    public static String getMACAddress() {
        WifiManager wifi = (WifiManager) ContextUtil.getApplicationContext()
    ...
    public static String getUniqueId() {
        SharedPreferences sharedPrefs = ContextUtil.getApplicationContext().getSharedPreferences(
    ...
    public static String getAndroidSerialNumber() {
        ...
        if (Build.VERSION.SDK_INT< Build.VERSION_CODES.M) {
            serialNumber = Md5.getMD532(getIMEI()+ WlanMacId()+ AndroidId());
        }else{
            serialNumber=getGenerateAndroidSerialNumber();
        }
    ...
    public static String getGenerateAndroidSerialNumber() {
        if (TextUtils.isEmpty(SharedPreUtil.getString(SharedPreUtil.GENERATE_SERIAL_NUMBER)))
        {
            SharedPreUtil.putString(SharedPreUtil.GENERATE_SERIAL_NUMBER,UUID.randomUUID().toString().replaceAll("-",""));
        }
        String serialNumber =  SharedPreUtil.getString(SharedPreUtil.GENERATE_SERIAL_NUMBER);
    ...
    public static String AndroidId() {
        ...
        String m_szAndroidID = Settings.Secure.getString(ContextUtil.getApplicationContext().getContentResolver(),
    ...
    public static String WlanMacId() {
        ...
        WifiManager wm = (WifiManager) ContextUtil.getApplicationContext()
                .getSystemService(Context.WIFI_SERVICE);
